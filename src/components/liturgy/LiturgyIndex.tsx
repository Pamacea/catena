...
export function LiturgyIndex({ initialCategory = "all" }: LiturgyIndexProps) {
 ...
 className="w-full px-4 py-3 rounded-lg border border-parchment-300 focus:border-gold-400 focus:ring-2 focus:ring-gold-200 outline-none text-lg text-ink-800 placeholder:text-ink-400"
 />
 </div>
