...
export function BilingualText({
 ...
 {/* Colonne Latine */}
 {showLatin && (
 <div className="border border-gold-400/40 rounded-l-lg bg-white">
 <div className="bg-liturgical-purple/10 px-4 py-2.5 border-b border-gold-400/40">
 <p className="text-sm font-bold text-ink-800 flex items-center gap-2">
 <span className="text-xs bg-liturgical-purple/20 text-ink-800 px-2 py-0.5 rounded font-semibold">LATIN</span>
 Latina
 </p>
 </div>
 ...
 {/* Colonne Française */}
 <div className={cn("border border-gold-400/40 bg-white", showLatin ? "rounded-r-lg border-l-0" : "rounded-lg")}>
 <div className="bg-gold-500/10 px-4 py-2.5 border-b border-gold-400/40">
 <p className="text-sm font-bold text-ink-800 flex items-center gap-2">
 <span className="text-xs bg-gold-500/20 text-ink-800 px-2 py-0.5 rounded font-semibold">FR</span>
 Français
 </p>
 </div>
...
export function VersePair({ latin, french, verseNumber }: VersePairProps) {
 ...
 {verseNumber && (
 <span className="col-span-2 text-xs text-ink-600 font-medium">{verseNumber}</span>
 )}
...
export function ParallelText({ sections, showLatin = true }: ParallelTextProps) {
 ...
 {/* Latin */}
 {showLatin && (
 <div className="border border-gold-400/40 rounded-l-lg bg-white p-4">
 <p className="text-xs text-ink-600 uppercase mb-3 font-bold flex items-center gap-2">
 <span className="bg-liturgical-purple/20 text-ink-700 px-1.5 py-0.5 rounded text-[10px] font-semibold">LATIN</span>
 Latina
 </p>
 ...
 {/* Français */}
 <div className={cn("border border-gold-400/40 bg-white p-4", showLatin ? "rounded-r-lg border-l-0" : "rounded-lg")}>
 <p className="text-xs text-ink-600 uppercase mb-3 font-bold flex items-center gap-2">
 <span className="bg-gold-500/20 text-ink-700 px-1.5 py-0.5 rounded text-[10px] font-semibold">FR</span>
 Français
 </p>
 <div className="space-y-2">
