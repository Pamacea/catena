...
export const deuteronomyChapterOutlines: ChapterOutline[] = [
  ...
  },
  {
    ...
    keyEvents: [ ""Alliance dans le pays de Moab", 'Avec ceux qui sont là aujourd"hui", "Idolâtrie rootée"\", "Choses cachées et révélées", 'Retour à l"Éternel", "Exil et restauration"],
...
export const deuteronomyKeyPassages: KeyPassage[] = [
  {
    ...
    title: "Le Shema Israel",
    text: "Écoute, Israël! L'Éternel, notre Dieu, est le seul Éternel. Tu aimeras l'Éternel, ton Dieu, de tout ton cœur, de toute ton âme et de toute ta force. Et ces paroles que je te commande aujourd"hui seront dans ton cœur. Tu les inculqueras à tes enfants, et tu en parleras quand tu seras dans ta maison, quand tu iras en voyage, quand tu te coucheras et quand tu te lèveras. Tu les lieras comme un signe sur ta main, et elles seront comme des fronteaux entre tes yeux. Tu les écriras sur les poteaux de ta maison et sur tes portes.", commentary: `Le Shema Israel ("Écoute, Israël") est la confession fondamentale du judaïsme et du christianisme. Cité par Jésus comme le plus grand commandement (Mt 22:37; Mc 12:29; Lc 10:27).
...
- ""Un" (Ehad): Peut signifier 'unique'" (unicité) ou "unifié' (Dieu unifié dans ses attributs).
...
Le Deutéronome montre que la foi est un choix quotidien. Chaque génération doit choisir. La grâce de Dieu est offerte mais doit être reçue. "Choisis la vie!' est l'appel final de Moïse et l'appel de Dieu à chaque génération.`,
    crossReferences: [ "Romains 10:6-10 (La parole près de toi)",
      "Josué 24:15 (Choisissez aujourd"hui)", "Matthieu 7:13-14 (Porte étroite et large)",
